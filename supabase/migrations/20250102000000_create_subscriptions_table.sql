-- Clean up any old triggers or functions that may conflict
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Drop any existing create_user_subscription functions with different signatures
...
-- Drop any old subscriptions table if it exists with wrong schema
